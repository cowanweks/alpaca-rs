...
pub mod fixtures {
    ...
    pub fn sample_account() -> Account {
        Account {
            id: Uuid::new_v4(),
            admin_configurations: serde_json::json!({}),
            ...
            effective_buying_power: "100000.00".to_string(),
            non_marginable_buying_power: "50000.00".to_string(),
            options_buying_power: "50000.00".to_string(),
            ...
            position_market_value: "0.00".to_string(),
            initial_margin: "0.00".to_string(),
            maintenance_margin: "0.00".to_string(),
            last_maintenance_margin: "0.00".to_string(),
            sma: "0.00".to_string(),
            balance_asof: Utc::now().date_naive(),
            crypto_tier: 1,
            intraday_adjustments: "0".to_string(),
            pending_reg_taf_fees: "0".to_string(),
